...
var renderChannels = function renderChannels(_ref) {
...
var renameBodytoChannels = function renameBodytoChannels(body) {
  return {
    channels: body
  };
};
...
Page.getInitialProps = function () {
  return fetch("https://api.audioboom.com/channels/recommended").then(function (response) {
    return response.json();
  }).then(function (response) {
    return renameBodytoChannels(response.body);
  });
};
